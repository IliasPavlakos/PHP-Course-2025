...
$welcomeHeading = 'Welcome To The Course';
$welcomeDescription = 'In this course, you will learn the fundamentals of the PHP language';
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-4 mt-4">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-semibold mb-4"><?= $welcomeHeading ?></h2>
